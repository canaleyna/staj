...
const addTodo = (e) => {
   ...
   if (inputVal == '')  { // boþ deðer girilmeye çalýþýyor ise hata veriyoruz
...
const saveTodo = (e) => {
   const todo = e.target.parentElement.parentElement;
   const prevText = todo.firstChild.children[1].textContent; // deðiþtirilmeden önceki deðer
   const newText = todo.firstChild.children[2].value; // editlerken girdiðimiz yeni deðer
   ...
   todo.firstChild.children[1].textContent = newText;  // HTML üzerindeki deðerini de deðiþtiriyoruz

   todo.classList.remove("-edited"); // verdiðimiz classý kaldýrýyoruz
}
